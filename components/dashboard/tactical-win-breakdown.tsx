    ...
    <Card className="bg-[#0F141C] border-[#1C2433]">
      <CardHeader className="py-4 px-5 border-b border-[#1C2433]">
        ...
        <CardDescription className="text-xs text-[#94A3B8]">
          Distribusi ronde berdasarkan kondisi objektif tim & kedisiplinan crosshair trade
        </CardDescription>
      </CardHeader>
          ...
          <>
            ...
            <div className="space-y-3">
              <div className="flex items-center justify-between">
                ...
                <span className="text-[11px] text-[#94A3B8]">Distribusi Objektif Menang</span>
              </div>
            ...
            <div className="space-y-3 pt-2 border-t border-[#1C2433]">
              <div className="flex items-center justify-between">
                ...
                <span className="text-[11px] text-[#94A3B8]">Distribusi Celah Kalah</span>
              </div>
            ...
            <div className="p-4 rounded-xl bg-[#090C10] border border-[#1C2433] space-y-3.5 pt-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 text-center">
                <div className="p-3 rounded-lg bg-[#0F141C] border border-emerald-500/20">
                  ...
                  <span className="text-xl font-black text-emerald-400 font-mono">{trade.tradedDeaths}</span>
                  <span className="text-[10px] text-[#94A3B8] block">Dibalas cepat oleh rekan</span>
                </div>
                <div className="p-3 rounded-lg bg-[#0F141C] border border-sky-500/20">
                  ...
                  <span className="text-xl font-black text-sky-400 font-mono">{trade.tradesWon}</span>
                ...
                <div className="p-3 rounded-lg bg-[#0F141C] border border-rose-500/20">
                  ...
                  <span className="text-xl font-black text-rose-400 font-mono">{trade.untradedDeaths}</span>
