...
export const VALORANT_AGENTS: AgentInfo[] = [
  ...
  { name: "Skye", role: "Initiator", color: "#4ADE80", icon: "https://media.valorant-api.com/agents/6f2a04ca-43e0-be17-7f36-b39086d3548b/displayicon.png" },
  ...
  { name: "Harbor", role: "Controller", color: "#06B6D4", icon: "https://media.valorant-api.com/agents/22697a3d-45bf-8dd7-4fec-84a9e28c69d7/displayicon.png" },
  ...
  { name: "Vyse", role: "Sentinel", color: "#C084FC", icon: "https://media.valorant-api.com/agents/52e9749a-429b-7060-9924-a0aa80d05482/displayicon.png" },
];
